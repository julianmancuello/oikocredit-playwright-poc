...
Feature: E2E - Orders in MyOikocredit Investor Portal
  ...
  Scenario Outline: E2E - Order Flow - <TransactionType>
    ...
    And the user logs into MYOIKOCREDIT LTP as individual with valid credentials
    Then the user checks that the <TransactionType> order still appears in progress in the transactions
